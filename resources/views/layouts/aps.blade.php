...
<head>
    ...
    <title>Payroll by Delibra</title>
    <!-- Fonts and icons -->
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html "
                ...
                <span class="ms-1 font-weight-bold">Payroll</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() == 'jabatan.index' ? 'active' : '' }}" href="{{ route('jabatan.index') }}">
                        <div
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() == 'karyawan.index' ? 'active' : '' }}" href="{{ route('karyawan.index') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() == 'absensi.index' ? 'active' : '' }}" href="{{ route('absensi.index') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    ...
                    <ul class="dropdown-menu bg-gray-100" aria-labelledby="navbarDropdown" style="margin-top: 0;">
                        <li class="dropdown-item" style="padding: 0px 15px;">
                            <a class="nav-link {{ Route::currentRouteName() == 'jenisgaji.index' ? 'active' : '' }}" href="{{ route('jenisgaji.index') }}">
                                <div
                                    class="icon icon-shape icon-sm shadow text-center d-flex align-items-center justify-content-center">
                                    <ion-icon name="keypad-outline"></ion-icon>
                                </div>
                                <span class="nav-link-text ms-1">Jenis Gaji</span>
                            </a>
                        </li>
                        <li class="dropdown-item" style="padding: 0px 15px;">
                            <a class="nav-link {{ Route::currentRouteName() == 'gaji.index' ? 'active' : '' }}" href="{{ route('gaji.index') }}">
                                <div
                                    class="icon icon-shape icon-sm shadow text-center d-flex align-items-center justify-content-center">
                ...
                {{-- <li class="nav-item">
                    ...
                    <ul class="dropdown-menu bg-gray-100" aria-labelledby="navbarDropdown" style="margin-top: 0;">
                        <li class="dropdown-item" style="padding: 0px 15px;">
                            <a class="nav-link {{ Route::currentRouteName() == 'slipgaji.index' ? 'active' : '' }}" href="{{ route('slipgaji.index') }}">
                                <div
                                    class="icon icon-shape icon-sm shadow text-center d-flex align-items-center justify-content-center">
                        ...
                        <li class="dropdown-item" style="padding: 0px 15px;">
                            <a class="nav-link {{ Route::currentRouteName() == 'laporan.index' ? 'active' : '' }}" href="{{ route('laporan.index') }}">
                                <div
                                    class="icon icon-shape icon-sm shadow text-center d-flex align-items-center justify-content-center">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">
                            @if(Route::currentRouteName() == 'jabatan.index')
                                Data Jabatan
                            @elseif(Route::currentRouteName() == 'karyawan.index')
                                Data Karyawan
                            @else
                                Beranda
                            @endif
